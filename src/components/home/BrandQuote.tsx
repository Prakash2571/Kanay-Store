      ...
      <div className="relative overflow-hidden rounded-[var(--radius-card)] border border-line bg-quote-bg px-6 py-12 text-center sm:px-10 sm:py-14 lg:py-16">
        ...
        */}
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <p
            className="mt-5 text-[1.55rem] font-extrabold leading-[1.2] tracking-[-0.025em] sm:text-[2rem] lg:text-[2.3rem]"
          ...
          <p className="mx-auto mt-6 max-w-[58ch] text-sm leading-7 text-ink-muted sm:text-base">
