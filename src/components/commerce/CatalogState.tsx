...
export function CatalogEmpty({
  ...
  return (
    <div className="grid min-h-64 place-items-center rounded-[var(--radius-card)] border border-line bg-surface px-6 py-12 text-center">
      <div>
        <span className="mx-auto grid size-12 place-items-center rounded-[var(--radius-pill)] bg-surface-peach-soft">
          <SearchX aria-hidden="true" className="text-accent-ink" size={24} strokeWidth={ICON_STROKE} />
        </span>
        ...
        <Link
          className="mt-6 inline-flex min-h-11 items-center justify-center rounded-[var(--radius-control)] bg-accent px-6 text-sm font-bold text-white transition-colors hover:bg-accent-hover focus-visible:outline focus-visible:outline-2 active:translate-y-px"
          href="/shop"
        >
          Browse all products
        </Link>
...
export function CatalogError() {
  return (
    ...
    >
      <div>
        <span className="mx-auto grid size-12 place-items-center rounded-[var(--radius-pill)] bg-surface-peach-soft">
          <ShoppingBag aria-hidden="true" className="text-accent-ink" size={24} strokeWidth={ICON_STROKE} />
        </span>
