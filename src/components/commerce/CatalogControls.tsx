  ...
  return (
    <form action={action} className="grid gap-4 border-y border-line py-5 sm:grid-cols-2 lg:grid-cols-6" method="get">
      ...
      <div className="flex items-end">
        <button className="min-h-11 w-full rounded-[var(--radius-control)] bg-brand px-5 text-sm font-bold text-white transition-opacity hover:opacity-85 focus-visible:outline focus-visible:outline-2 active:translate-y-px" type="submit">Apply filters</button>
      </div>
    </form>
  );
}
